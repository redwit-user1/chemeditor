...
var a = /* @__PURE__ */ "ADDRESS.ARTICLE.ASIDE.AUDIO.BLOCKQUOTE.BODY.CANVAS.CENTER.DD.DIR.DIV.DL.DT.FIELDSET.FIGCAPTION.FIGURE.FOOTER.FORM.FRAMESET.H1.H2.H3.H4.H5.H6.HEADER.HGROUP.HR.HTML.ISINDEX.LI.MAIN.MENU.NAV.NOFRAMES.NOSCRIPT.OL.OUTPUT.P.PRE.SECTION.TABLE.TBODY.TD.TFOOT.TH.THEAD.TR.UL".split(".");
function o(e) {
	return p(e, a);
}
var s = [
...
_.paragraph = {
	...
	filter: "li",
	replacement: function(e, t, n) {
		var r = n.bulletListMarker + "   ", a = t.parentNode;
		if (a.nodeName === "OL") {
			var o = a.getAttribute("start"), s = Array.prototype.indexOf.call(a.children, t);
			r = (o ? Number(o) + s : s + 1) + ".  ";
		}
		var c = /\n$/.test(e);
	...
	replacement: function(e, n, r) {
		for (var i = ((n.firstChild.getAttribute("class") || "").match(/language-(\S+)/) || [null, ""])[1], a = n.firstChild.textContent, o = r.fence.charAt(0), s = 3, c = RegExp("^" + o + "{3,}", "gm"), l; l = c.exec(a);) l[0].length >= s && (s = l[0].length + 1);
		var u = t(o, s);
		return "\n\n" + u + i + "\n" + a.replace(/\n$/, "") + "\n" + u + "\n\n";
	}
}, _.horizontalRule = {
	...
	replacement: function(e, t) {
		var n = y(t.getAttribute("href")), r = b(v(t.getAttribute("title"))), i = r ? " \"" + r + "\"" : "";
		return "[" + e + "](" + n + i + ")";
	}
}, _.referenceLink = {
	filter: function(e, t) {
	...
	replacement: function(e, t, n) {
		var r = y(t.getAttribute("href")), i = v(t.getAttribute("title"));
		i &&= " \"" + b(i) + "\"";
		var a, o;
	...
	filter: "img",
	replacement: function(e, t) {
		var n = g(v(t.getAttribute("alt"))), r = y(t.getAttribute("src") || ""), i = v(t.getAttribute("title")), a = i ? " \"" + b(i) + "\"" : "";
		return r ? "![" + n + "](" + r + a + ")" : "";
	}
};
function v(e) {
...
var j = O() ? D.DOMParser : k();
function M(e, t) {
	var n = typeof e == "string" ? P().parseFromString("<x-turndown id=\"turndown-root\">" + e + "</x-turndown>", "text/html").getElementById("turndown-root") : e.cloneNode(!0);
	return w({
		element: n,
		isBlock: o,
		isVoid: c,
...
function I(e, t) {
	return e.isBlock = o(e), e.isCode = e.nodeName === "CODE" || e.parentNode.isCode, e.isBlank = L(e), e.flankingWhitespace = R(e, t), e;
}
function L(e) {
	return !c(e) && !d(e) && /^\s*$/i.test(e.textContent) && !l(e) && !f(e);
}
function R(e, t) {
	...
	return n.leadingAscii && B("left", e, t) && (n.leading = n.leadingNonAscii), n.trailingAscii && B("right", e, t) && (n.trailing = n.trailingNonAscii), {
		leading: n.leading,
		trailing: n.trailing
	};
}
...
function B(e, t, n) {
	var r, i, a;
	return e === "left" ? (r = t.previousSibling, i = / $/) : (r = t.nextSibling, i = /^ /), r && (r.nodeType === 3 ? a = i.test(r.nodeValue) : n.preformattedCode && r.nodeName === "CODE" ? a = !1 : r.nodeType === 1 && !o(r) && (a = i.test(r.textContent))), a;
}
...
function H(t) {
	...
	this.options = e({}, n, t), this.rules = new x(this.options);
}
H.prototype = {
	turndown: function(e) {
		if (!q(e)) throw TypeError(e + " is not a string, or an element/document/fragment node.");
		if (e === "") return "";
		var t = U.call(this, new M(e, this.options));
...
function U(e) {
	var t = this;
	return V.call(e.childNodes, function(e, n) {
		n = new I(n, t.options);
		var r = "";
		return n.nodeType === 3 ? r = n.isCode ? n.nodeValue : t.escape(n.nodeValue) : n.nodeType === 1 && (r = G.call(t, n)), K(e, r);
	}, "");
}
function W(e) {
	var t = this;
	return this.rules.forEach(function(n) {
		typeof n.append == "function" && (e = K(e, n.append(t.options)));
	}), e.replace(/^[\t\r\n]+/, "").replace(/[\t\r\n\s]+$/, "");
}
function G(e) {
	var t = this.rules.forNode(e), n = U.call(this, e), r = e.flankingWhitespace;
	return (r.leading || r.trailing) && (n = n.trim()), r.leading + t.replacement(n, e, this.options) + r.trailing;
}
function K(e, t) {
	var i = r(e), a = n(t), o = Math.max(e.length - i.length, t.length - a.length);
	return i + "\n\n".substring(0, o) + a;
}
function q(e) {
